"""
Django settings for restexp project.
...
SECRET_KEY = 'django-insecure-(+g7*x^0-v**yt%otrg06^8m@tnm#n8wuauel$xd)_%npv#f7m'
...
WSGI_APPLICATION = 'restexp.wsgi.application'
